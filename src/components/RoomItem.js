...
import { IdbContext } from "../App";
 ...
 function RoomItem({ itemName, unityContext, onDelete}) {
    ...
    function SpawnItemEvent() {
        unityContext.send("LevelManager", "SpawnRoom", itemName );
    ...
    async function doDelete(){
        ...
        const response = await fetch('/delete.php?filepath=' + context.currentRoomId + '/rooms/' + itemName);
