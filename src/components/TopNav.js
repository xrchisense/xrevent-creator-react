				...
				<Container fluid>
					...
					<Form.Group className="justify-content-center"   >
						<InputGroup style={{ width: 450 }}>
							<Form.Control placeholder="Enter XReventId to load event room ..." value={textField} onChange={e => handleTextChange(e.target.value)} onFocus={handleFocus} />
							...
							<OverlayTrigger	placement="bottom" delay={{ show: 1000, hide: 250 }} overlay={ <Tooltip>Copy XRevent roomID</Tooltip>}>
								<span className="input-group-text" >
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" type="button" className="bi bi-clipboard" viewBox="0 0 16 16">
